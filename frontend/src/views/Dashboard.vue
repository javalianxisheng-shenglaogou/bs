    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <el-card shadow="hover">
          <el-statistic title="用户总数" :value="26">
            <template #prefix>
      ...
      <el-col :span="6">
        <el-card shadow="hover">
          <el-statistic title="站点数量" :value="8">
            <template #prefix>
      ...
      <el-col :span="6">
        <el-card shadow="hover">
          <el-statistic title="内容总数" :value="250">
            <template #prefix>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item label="系统名称">多站点CMS系统</el-descriptions-item>
...
const testApi = async () => {
  try {
    ...
    ElMessage.success('API连接成功: ' + res.data.message)
  } catch (error) {
